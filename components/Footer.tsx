            ...
            <div className="container mx-auto flex items-center flex-col sm:flex-row py-8">
                <Link href="/"
                    className="flex items-center justify-center md:justify-start text-gray-900">
                             <Image src="/logo.png" height={40} width={100} />
                ...
                <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                    <Link className="text-gray-500" href='https://www.facebook.com/aliabubakar991/'>
                        <svg
                            fill="currentColor"
                            strokeLinecap="round"
                    ...
                    <Link className="ml-3 text-gray-500" href='https://www.instagram.com/ali.ansari7268/'>
                        <svg
                            fill="none"
                            stroke="currentColor"
                            strokeLinecap="round"
                    ...
                    <Link className="ml-3 text-gray-500" href='https://www.linkedin.com/in/ali-abubakar-b948b221b/'>
                        <svg
                            fill="currentColor"
                            stroke="currentColor"
                            strokeLinecap="round"
